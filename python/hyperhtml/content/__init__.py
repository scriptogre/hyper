...
Load with validation by combining Singleton/Collection with your validation library:
    import pydantic
    from hyperhtml import Singleton
...
Or with msgspec:
    import msgspec
    from hyperhtml import Collection, Markdown
...
from hyperhtml.content._mixins import CollectionMixin, SingletonMixin
from hyperhtml.content.computed import computed
from hyperhtml.content.loader import load
from hyperhtml.content.markdown import MarkdownCollection, MarkdownSingleton
